...
<body>
	...
	<div class="main"
		...
		<div class="container">
			<h1 class="logo cursive">Ly Ly Shop</h1>
		...
		<div class="footer">
			<div class="container">
				...
				<a href="http://www.facebook.com/thanhlydao97">Lý Ly Shop</a>.
				<s:message code="employee.login.contact" />
				<a href="http://www.fakebook.com/thanhlydao97"><s:message
