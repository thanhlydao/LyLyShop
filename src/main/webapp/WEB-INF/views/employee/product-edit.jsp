...
<!DOCTYPE html>
<html lang="en">
<script src="/LyLyShop/nicEditor/nicEdit.js" type="text/javascript"></script>
<script type="text/javascript">
	bkLib.onDomLoaded(function() {
		//new nicEditor().panelInstance('description');
		new nicEditor({
			fullPanel : true,
			iconsPath : '/LyLyShop/nicEditor/nicEditorIcons.gif',
			uploadURI : '/LyLyShop/nicEditor/upload',
			...
			<div class="container-fluid">
				...
				<div class="row page-titles">
					...
					<div class="col-md-7 col-4 align-self-center">
						<a href="http://facebook.com/Thanhlydao97" target="blank"
