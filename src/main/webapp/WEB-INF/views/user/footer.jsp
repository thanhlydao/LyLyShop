...
<div id="footerSection">
	<div class="container">
		<div class="row">
			...
			<div id="socialMedia" class="span3 pull-right">
				...
				<a href="http://facebook.com/thanhlydao97" target="blank"><img
					width="60" height="60" src="themes/images/facebook.png"
					title="facebook" alt="facebook"></a> <a
					href="https://twitter.com/thanhlydao" target="blank"><img
		...
		<br>
		<p class="pull-right">© Lý Ly Shop - 0933.322.904 (từ 8h-21h,
			kể cả T7-CN)</p>
	...
	<!-- Container End -->
	<script src="https://dochat.vn/code.js?id=9190513115904185204"></script>
</div>
