		...
		<div class="container">
			<div class="row">
				...
				<div class="span9" id="mainCol">
					...
					<hr class="soft">
					<h4>1. Hình Thức Mua Hàng Online Tại Lý Ly Shop</h4>
					<p>- Bạn đăt hàng trên Web → Nhân viên Lý Ly Shop sẽ gọi
						điện thoại xác nhận đơn hàng của bạn → Giao hàng và Thu tiền tận
						nơi trên toàn quốc.</p>
					<br>

					<h4>2. Thời gian mở cửa tại các Shop của Lý Ly Shop</h4>
					<p>- Các shop của Lý Ly Shop mở cửa từ 8h tới 21h tất cả các
						ngày, kể cả thứ 7 và Chủ Nhật</p>
					<br>

					<h4>3. Có phải đặt hàng online trên trang website trước khi
						đến các Shop của Lý Ly Shop hay không?</h4>
					<p>- Lý Ly Shop có đầy đủ các mặt hàng mà trên website bán,
						bạn có thể tới trực tiếp mua hàng không cần đặt trước trên website</p>
					<br>

					<h4>4. Mua tại các shop của Lý Ly Shop có nhận được tiền
						tích lũy không ?</h4>
					<p>- Tiền tích lũy chỉ áp dụng cho các thành viên của Website
						Lý Ly Shop mua hàng online bạn nhé.</p>
					<br>

					<h4>5. Giá các sản phẩm tại các shop Lý Ly Shop có giống
						giá trên Website Lý Ly Shop không ?</h4>
					<p>- Tất cả sản phẩm trên Website Lý Ly Shop bán giống giá
						với tất cả các hệ thống Shop của Lý Ly Shop.</p>
					<br>

					<h4>6. Địa chỉ các Shop của Lý Ly Shop xem ở đâu ?</h4>
					<p>- Bạn bấm phần “Liên Hệ” trên đầu trang website để coi địa
						chỉ và số điện thoại các của các Shop của Lý Ly Shop.</p>
					<br>

					<h4>7. Xem phí vận chuyển như thế nào ?</h4>
					<p>- Tất cả các mặt hàng tại Lý Ly Shop có dịch vụ giao hàng
					...
					<h4>9. Hàng của Lý Ly Shop đổi có giao hàng tận nơi không?</h4>
					...
					<p>- Ở Hà Nội nhân viên Lý Ly Shop giao hàng tận nơi.</p>
					<br>
					...
					<p>- Bạn trở thành khách hàng thân thiện sẽ được tham gia miễn
						phí tất cả các chương trình giảm giá của Lý Ly Shop và còn được
					...
					<h4>12. Hình thức đổi trả hàng như thế nào, nếu Sản Phẩm bị
						lỗi do Lý Ly Shop hoặc nhà sản xuất ?</h4>
					<p>- Bạn Có thể đổi trong vòng 7 ngày theo quy định của shop ,
						bạn gửi lại qua đường bưu điện về địa chỉ 06 Trần Văn Ơn, Phú Hòa
						Thủ Dầu Một, Bình Dương hoặc bạn có thể mang tới
						tận nơi bạn nhé.</p>
					<br>
					...
					<p>- Một số mặt hàng bên Lý Ly Shop giao màu ngẫu nhiên, bên
						Lý Ly Shop có nói rõ trong phần chi tiết sản phẩm.</p>
					<br>

					<h4>15. Sản phẩm bên ngoài có giống trong hình trên Website
						không?</h4>
					<p>- Sản phẩm được Lý Ly Shop được đặt riêng với tiêu chí
