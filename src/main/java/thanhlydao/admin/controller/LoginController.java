...
import thanhlydao.admin.service.AccountService;
import thanhlydao.admin.service.EmployeeService;
import thanhlydao.admin.validator.EmployeeValidator;
import thanhlydao.model.Admin;
import thanhlydao.model.Employee;
		...
		try {
			...
			if (email.equals(employee.getEmail())) {
				...
				try {
					...
					helper.setFrom("Lý Ly Shop <thanhlydao97@gmail.com>");
					helper.setTo(email);
					helper.setReplyTo("Lý Ly Shop <thanhlydao@gmail.com>");
