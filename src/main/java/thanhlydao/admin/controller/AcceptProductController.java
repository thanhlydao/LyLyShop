...
import thanhlydao.admin.validator.ProductValidator;
import thanhlydao.model.Product;
import thanhlydao.admin.service.ProductService;

@Controller
@Transactional
@RequestMapping(value = "admin/product")

public class AcceptProductController extends LyLyShopController {
	@Autowired
