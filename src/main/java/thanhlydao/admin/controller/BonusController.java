...
import thanhlydao.admin.service.BonusService;
import thanhlydao.admin.validator.BonusValidator;
import thanhlydao.model.Bonus;

@Transactional
@Controller
@RequestMapping(value = "admin/bonus")

public class BonusController extends LyLyShopController {
	@Autowired
